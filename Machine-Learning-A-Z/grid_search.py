# Grid Search
#Knew about this beforehand as well
...
# Applying Grid Search (finding best model and parameters)
from sklearn.model_selection import GridSearchCV
params = [{'C':[1,10,100,1000], 'kernel':['linear']},
          {'C':[1,10,100,1000], 'kernel':['rbf'], 'gamma':np.linspace(0.1, 0.9, 9)}
          ]

grid_search = GridSearchCV(clf, param_grid=params, scoring='accuracy', cv=10, n_jobs=-1)
