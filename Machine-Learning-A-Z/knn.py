...
clf = KNeighborsClassifier(n_neighbors=5, metric='minkowski', p=2) #p=1 for manhattan distance; p=2 for Euclidian distance; 
...
cm = confusion_matrix(y_test, y_pred)    #93 correct, 7 incorrect     
